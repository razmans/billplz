...
/**
 * @module CreateBillplzTest
 * @param payload CreateBillPayload
 * @returns
 */
/** Create billplz bill */

export async function CreateBillplzTest(
...
/**
 * @module DeleteBillplzTest
 * @param payload BillDataPayload
 * @returns
 */
/** Delete billplz bill */
export async function DeleteBillplzTest(
...
/**
 * @module CheckBillplzStatusTest
 * @param payload CheckBillStatusPayload
 * @returns
 */
/** Check billplz bill status */
export async function CheckBillplzStatusTest(
  payload: BillDataPayload
): Promise<any> {
  const username = payload.id;
  const basicAuthToken = btoa(`${username}:`);
...
/**
 * @module GetTransactionListBillplzTest
 * @param payload BillDataPayload
 * @returns
 */
/** Get all billplz transaction by ID */
export async function GetTransactionListBillplzTest(
  payload: BillDataPayload
): Promise<any> {
  const username = payload.id;
  const basicAuthToken = btoa(`${username}:`);
  try {
    const response = await fetch(
      `https://www.billplz-sandbox.com/api/v3/bills/${payload.billplzId}/transactions`,
      {
        method: 'GET',
        headers: {
          Authorization: `Basic ${basicAuthToken}`,
